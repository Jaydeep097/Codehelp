...
// end -> push
// begin -> unshift
// middle -> slice // numbers.slice(10)\\



// let first = [1,2,4,45,3];
// let second =[22,4,56,7,7,8,8,];

// let combined = [...first,'a',...second,'b'];
// console.log(combined);

// // if we want to create copy 
...
// let items = numbers.map(values => 'student number ' + values)
